...
import screenLevelGenre from './mainLevelGenre.js';

const srtLevelArtist = `  <!-- Игра на выбор исполнителя -->
...
const screenLevelArtist = createElement(srtLevelArtist);
...
*/
btnMainAnswer.addEventListener(`change`, (evt) => {
  evt.preventDefault();
  if (evt.target.tagName === `INPUT`) {
    openScreen(screenLevelGenre);
  }
});
