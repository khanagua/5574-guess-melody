...
import randomScreen from '../getRandomScreen.js';

const strLevelGenre = `  <!-- Игра на выбор жанра -->
...
const screenLevelGenre = createElement(strLevelGenre);
